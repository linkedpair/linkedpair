  ...
  return (
    <SafeAreaView style={styles.SafeAreaViewContainer}>
      <ScrollView contentContainerStyle={styles.MainContainer}>
        ...
        <UserAttribute type="First Name" initialValue={data.firstName} />
        <AttributeLineSeparator />
        <UserAttribute type="Last Name" initialValue={data.lastName} />
        <AttributeLineSeparator />
        <UserAttribute type="Display Name" initialValue={data.username} />
        <AttributeLineSeparator />
        <UserAttribute type="Age" initialValue={calculateAge(birthdate)} />
        <View style={styles.AboutContainer}>
        ...
        <AttributeLineSeparator />
        <UserAttribute type="Gender" initialValue={data.gender} />
        <AttributeLineSeparator />
        <UserAttribute type="Email" initialValue={data.email} />
        <AttributeLineSeparator />
        <View style={styles.WhiteSpace} />
      </ScrollView>
    </SafeAreaView>
